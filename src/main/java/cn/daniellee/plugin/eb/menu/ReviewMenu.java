	...
	public static Inventory generate(int page) {
		...
		for (int i = 0; i < 45; i++) {
			...
			if (building.getIntroduction() != null && !"".equals(building.getIntroduction())) {
				...
				for (int n = 0; n < introduction.size(); n++) introduction.set(n, "&r" + introduction.get(n));
